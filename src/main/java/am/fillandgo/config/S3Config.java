...
/**
 * Configuration class for setting up Amazon S3.
 */
@Configuration
public class S3Config {
    ...
    /**
     * Returns an instance of Amazon S3 client with the specified configuration.
     * @return an instance of Amazon S3 client
     */
    @Bean
    public AmazonS3 s3() {
